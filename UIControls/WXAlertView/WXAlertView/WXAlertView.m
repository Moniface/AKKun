...
#define kColorGrayButtonNormalBackground    RGBCOLOR(204,204,204)
#define kColorGrayButtonPressedBackground   RGBCOLOR(0xac,0xac,0xac)

#define kColorGreenButtonNormalBackground   RGBCOLOR(83,184,192)
#define kColorGreenButtonPressedBackground  RGBCOLOR(0x33,0x98,0xac)
...
- (void)layoutSubviews
{
    ...
    [_textLabel setFrame:CGRectMake(TextLabelSidePadding, 5.0,
                                    self.frame.size.width - 2*TextLabelSidePadding,
                                    textSize.height)];
...
- (void)_layoutSeparatorLines
{
    ...
    if (self.allButtons.count == 2) {
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pub_list_line"]];
        ...
        UIImageView *vertical = [[UIImageView alloc] initWithFrame:CGRectMake(_buttonsContainerView.center.x, 1,
                                                                              1, _buttonsContainerView.frame.size.height)];
        [vertical setImage:[UIImage imageNamed:@"pub_list_line_vertical"]];
